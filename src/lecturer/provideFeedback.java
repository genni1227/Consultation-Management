...
public class provideFeedback extends JPanel {
    ...
    public provideFeedback(String studentName, String appointmentDate, String appointmentTime, CardLayout cardLayout, JPanel cardPanel, pastAppointments pastAppointmentsPanel) {
